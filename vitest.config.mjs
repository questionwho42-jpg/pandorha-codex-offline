	...
	test: {
		...
		coverage: {
			include: [
				...
				"src/features/social/domain/SocialCombatEngine.ts",
				...
				"src/entities/campaign/domain/CampaignEventService.ts",
				"src/entities/downtime/domain/DowntimeService.ts",
				...
				"src/entities/espionage/domain/EspionageService.ts",
				"src/entities/mercenary/domain/MercenaryService.ts",
