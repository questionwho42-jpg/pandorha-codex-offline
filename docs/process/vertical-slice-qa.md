...
Este roteiro valida o MVP navegável atual do Pandorha Engine depois da T40. Ele não substitui `quality:gate`; ele descreve o caminho humano que deve ser repetido antes de expandir para NPCs e negociação social.
...
8. Entre em `Relações`, invoque `Favor Tier 1`, confirme `Dívida 1/3` e `Intriga 1`, salve, recarregue, carregue e confirme restauração.
...
- service worker presente com eventos básicos de PWA.
...
- Não há NPCs, negociação social real, diálogo em árvore ou HP mental.
