...
const projectRoot = await fs.mkdtemp(
	path.join(os.tmpdir(), "pandorha-memory-bridge-stdio-"),
);
			...
			send({
				...
				params: {
					...
					arguments: {
						...
						technical_summary:
							"The bridge created module context files in a temporary project root.",
						plain_english:
							"This confirms the memory bridge can write the three context files.",
					},
				},
			});
			continue;
