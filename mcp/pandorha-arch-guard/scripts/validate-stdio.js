...
const projectRoot = await fs.mkdtemp(path.join(os.tmpdir(), "pandorha-arch-guard-stdio-"));
const samplePath = path.join(projectRoot, "src", "features", "combat", "ui", "Panel.svelte");
