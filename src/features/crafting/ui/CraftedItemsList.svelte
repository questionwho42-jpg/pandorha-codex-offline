...
<div class="crafted-items-section flex flex-col gap-4 bg-ruin p-4 rounded border border-bronze/20 mt-2 z-10">
	...
	{#if characterItems.length === 0}
		<p class="text-xs text-bone/40 italic py-4 text-center">Nenhum item foi forjado para {characterName}. Acione o fole e comece a forja!</p>
	{:else}
