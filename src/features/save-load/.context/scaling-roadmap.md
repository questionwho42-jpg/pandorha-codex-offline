...
- Keep v8 limited to inventory ownership, equipment loadout events, and character trait selections; real HP, trait effects, starting equipment, editable sheet state, or additional social history require later version gates.
